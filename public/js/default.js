$(document).ready(function() {
	...
	'"We cannot resist the fascination of sacrifice, since a passion for sacrifices is part of a Chessplayer’s nature." (Rudolf Spielman)',	'"All I want to do, ever, is just play Chess." (Bobby Fischer)',
